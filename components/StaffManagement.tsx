    ...
    <div className="container mx-auto px-6 py-8 text-white">
      ...
      <Tabs value={tab} onValueChange={(v: string)=>setTab(v)}>
        <TabsList className="mb-4">
          <TabsTrigger value="fighters">選手</TabsTrigger>
          <TabsTrigger value="judges">裁判</TabsTrigger>
          <TabsTrigger value="staffs">工作人員</TabsTrigger>
          <TabsTrigger value="admins">管理人員</TabsTrigger>
        </TabsList>
